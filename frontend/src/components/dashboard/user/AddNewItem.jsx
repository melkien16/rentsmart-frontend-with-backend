          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="w-full h-32 border-2 border-dashed border-emerald-400/30 rounded-xl flex items-center justify-center text-emerald-400 hover:border-emerald-400/50 transition-colors cursor-pointer">
